...
import { Settings, Zap, Sparkles, Flame, ChevronDown, Search, MessageCircle, Terminal, Trash2, Layers, Sliders } from "lucide-react";
        ...
        <div className="s-body s-tab-pane" style={{ overflowY: "auto", paddingBottom: "10px", gap: "14px", display: "flex", flexDirection: "column", flex: 1, zIndex: 101, minHeight: 0 }}>
            ...
            {activeTab === 'general' && (
              <>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "8px", background: "rgba(255,255,255,0.03)", padding: "12px", borderRadius: "var(--r-8)", border: "1px solid rgba(255,255,255,0.06)", marginTop: "4px" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <label className="s-label" style={{ display: "flex", alignItems: "center", gap: "6px", fontSize: "12px", color: "var(--tx-1)", margin: 0 }}>
                      <Sliders size={13} style={{ color: "var(--accent)" }} /> Window Opacity
                    </label>
